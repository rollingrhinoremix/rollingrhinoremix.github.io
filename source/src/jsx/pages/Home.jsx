...
export default function HomePage() {
    return (
        <div id="home-page">
            <h1 class="home-title">Rolling Rhino Remix</h1>

            <img id="home-laptop-image" src="assets/HomePage/laptop.png" alt="laptop"/>

            <h1 class="home-title" style="top: -2em;">Ubuntu just got rolling.</h1>
            ...
            <div id="home-section2">
                ...
                {/* header */}
                <h1 id="home-section2-header">Why use Rolling Rhino Remix?</h1>
